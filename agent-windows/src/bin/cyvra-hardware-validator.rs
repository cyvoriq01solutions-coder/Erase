...
fn run() -> i32 {
    ...
    match cyvra_core::windows_hardware::try_collect(&cancellation) {
        Ok(inventory) => {
...
fn build_report(inventory: &HardwareInventoryV1) -> ValidationReport {
...
fn device_fields_are_consistent(
    record: &cyvra_core::hardware_inventory_v1::DeviceAndChassisIdentity,
) -> bool {
...
fn firmware_fields_are_consistent(
    record: &cyvra_core::hardware_inventory_v1::FirmwareProfile,
) -> bool {
...
fn processor_fields_are_consistent(
    record: &cyvra_core::hardware_inventory_v1::ProcessorProfile,
) -> bool {
...
fn memory_summary_fields_are_consistent(
    record: &cyvra_core::hardware_inventory_v1::MemorySummary,
) -> bool {
...
fn memory_module_fields_are_consistent(
    record: &cyvra_core::hardware_inventory_v1::MemoryModule,
) -> bool {
