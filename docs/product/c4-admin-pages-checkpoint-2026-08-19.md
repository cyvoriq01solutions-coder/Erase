...
- `accounts@cyvoriq.com` remains pending after email verification until CEO approval.
...
3. Initial Access allow identities: `ceo@cyvoriq.com`, `accounts@cyvoriq.com` only.
